            ...
            <div class='container relative mx-auto'>
                <div class='flex flex-nowrap py-6 lg:py-0 items-center'>
                    ...
                    <nav id="site-navigation" class="w-auto lg:w-full">
                        ...
                        <ul
                            class=" gap-4 lg:gap-12 items-center flex-col transition-all lg:flex-row content-start justify-start lg:justify-end flex lg:flex-wrap primary-menu reset-list-style px-6 lg:px-0 fixed bg-primary-black max-w-xl lg:max-w-full lg:bg-transparent text-black -right-full lg:right-0 top-0 lg:relative pt-16 pb-28 lg:pt-0 lg:pb-0 w-10/12 lg:w-auto z-30 lg:z-auto h-screen lg:h-auto overflow-y-auto lg:overflow-y-visible lg:min-h-0">
                            <div
                                class="close-menu lg:hidden flex font-medium cursor-pointer uppercase right-42px top-42px absolute z-50 items-center text-lg text-primary-white">
                                zamknij
                                <svg class="ml-18px" width="17" height="17" viewBox="0 0 17 17" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="#F5F0EC" stroke-width="3" stroke-linecap="round" />
                                </svg>
                            </div>
                    ...
                    if ( is_active_sidebar( 'header-search' ) ) : ?>
                                ...
                                <svg id="search-icon" class="cursor-pointer" width="20" height="20" viewBox="0 0 20 20"
                                    ...
                                    <path class="hidden lg:inline-block" fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill="#111111" />
                                    <path class=" inline-block lg:hidden" fill-rule="evenodd" clip-rule="evenodd"
                                        d="M8 0.25C3.71979 0.25 0.25 3.71979 0.25 8C0.25 12.2802 3.71979 15.75 8 15.75C9.87001 15.75 11.5853 15.0877 12.9242 13.9848L18.4697 19.5303L18.5538 19.6029C18.8474 19.8208 19.2641 19.7966 19.5303 19.5303C19.8232 19.2374 19.8232 18.7626 19.5303 18.4697L13.9848 12.9242C15.0877 11.5853 15.75 9.87001 15.75 8C15.75 3.71979 12.2802 0.25 8 0.25ZM8 1.75C11.4518 1.75 14.25 4.54822 14.25 8C14.25 11.4518 11.4518 14.25 8 14.25C4.54822 14.25 1.75 11.4518 1.75 8C1.75 4.54822 4.54822 1.75 8 1.75Z"
                                        fill="white" />
                                </svg>
                            </div>
